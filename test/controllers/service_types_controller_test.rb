...
class ServiceTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create service_type" do
    assert_difference('ServiceType.count') do
      post service_types_url, params: { service_type: { description: @service_type.description, name: @service_type.name, status: @service_type.status } }
    end
  ...
  test "should update service_type" do
    patch service_type_url(@service_type), params: { service_type: { description: @service_type.description, name: @service_type.name, status: @service_type.status } }
