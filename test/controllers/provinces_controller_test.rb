...
class ProvincesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create province" do
    assert_difference('Province.count') do
      post provinces_url, params: { province: { abbreviation: @province.abbreviation, name: @province.name } }
    end
  ...
  test "should update province" do
    patch province_url(@province), params: { province: { abbreviation: @province.abbreviation, name: @province.name } }
